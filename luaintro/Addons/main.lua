...
function addon.DrawLoadScreen()
	...
	-- background
	gl.Color(0.02,0.04,0.10,(blurShader and 0.6 or 0.75))
	gl.Rect(posX+loadvalue,posY,1-posX,posY+(height/vsy))

	-- progress value
	gl.Color(0.0 + loadProgress*0.1, 0.2 + loadProgress*0.6, 0.4 + loadProgress*0.6, 0.9)
	...
	-- progress value
	gl.Color(0.0 + loadProgress*0.05, 0.15 + loadProgress*0.5, 0.35 + loadProgress*0.55, 0.3)
	...
	gl.Color(0.0 + loadProgress*0.05, 0.15 + loadProgress*0.45, 0.35 + loadProgress*0.5, 0.25)
